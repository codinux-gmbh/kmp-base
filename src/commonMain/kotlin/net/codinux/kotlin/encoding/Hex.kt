package net.codinux.kotlin.encoding

// Copied from korlibs/korge: https://github.com/korlibs/korge/blob/main/krypto/src/commonMain/kotlin/korlibs/crypto/encoding/Hex.kt
...
//val String.unhex: ByteArray get() {
...
//val ByteArray.hex get() = asUByteArray().joinToString("") { it.toString(16).padStart(2, '0') } // Hex.encodeLower(this)