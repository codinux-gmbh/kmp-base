...
ext["customArtifactId"] = "kmp-base-text" // TODO: find a better name

ext["projectDescription"] = "Text specific functionalities not in Kotlin standard library like Charset"
